...
const ProductQuantity = (props) => {
    ...
    return (
        <>
            <main className="main-product-quantity">

                <p className="title-product-quantity">Quantity</p>

                <section className="qua-product-quantity">
                    <figure className="remove-product-quantity">
                    ...
                    <figure className="add-product-quantity">

                        <svg xmlns="http://www.w3.org/2000/svg" width="22" height="20" viewBox="0 0 22 22" onClick={() => proQnty < 10 ? setProQty(proQnty + 1) : false}>
                            <g id="plus-circle" transform="translate(-1 -1)">
                                <circle id="Ellipse_148" dataname="Ellipse 148" cx="10" cy="10" r="10" transform="translate(2 2)" fill={proQnty < 10 ? "none" : "#EAEBEB"} stroke="#91959C" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
                ...
                <section className="add-cart-product-quantity">
                    <button type="submit" onClick={addCart} >ADD TO Cart</button>
                </section>

                <section className="save-share-product-quantity">
                    <figcaption className="save-product-quantity">
                        <svg className="svg-save-product-quantity" xmlns="http://www.w3.org/2000/svg" width="22.903" height="20.232" viewBox="0 0 22.903 20.232" onClick={() => proFav()}>
                            <path id="heart" d="M20.84,4.61a5.5,5.5,0,0,0-7.78,0L12,5.67,10.94,4.61a5.5,5.5,0,0,0-7.78,7.78l1.06,1.06L12,21.23l7.78-7.78,1.06-1.06a5.5,5.5,0,0,0,0-7.78Z" transform="translate(-0.549 -1.998)" fill={props.proQuantity.favourite ? 'rgb(27, 37, 44)' : 'none'} stroke="#172026" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
                        </svg>
                        <p className="text-save-product-quantity">Save</p>
                    </figcaption>
                    <figcaption className="share-product-quantity">
                        ...
                        <p className="text-share-product-quantity">Share</p>
                    </figcaption>
                </section>
