...
import swatchOneImg from "../../../assets/Swatch 01.png"
import swatchTwoImg from "../../../assets/Swatch 02.png"
import swatchThreeImg from "../../../assets/Swatch 03.png"
import swatchFourImg from "../../../assets/Swatch 04.png"
...
const ProductFormat = () => {
    ...
    let [colorFlag, setColorFlag] = useState([true, false, false, false]);

    const updateColorFlag = (i) => {
        let colorFlagCopy = [false, false, false, false];
        colorFlagCopy[i] = true;
        setColorFlag(colorFlagCopy);
    }

    const updatesizeFlag = (i) => {
        let sizeFlagCopy = sizeFlag.map((o) => {
            o.isSelect = false;
            return o;
        });

        sizeFlagCopy[i].isSelect = true;
