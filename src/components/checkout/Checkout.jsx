...
const Checkout = () => {
  ...
  let cartProducts = allProducts.filter((o) => o?.addCart);
  ...
  return (
    <>
      <main className="main-checkout">
        ...
        {onLoad.cartItemsTab ? (
          <section className="checkout-add-cart-products-summary">
            <div className="checkout-add-cart-products-title">
              <p className="checkout-sub-section-title">
                {len} items in your order
              </p>
            </div>
        ...
        {onLoad.shippingMethodTab ? (
          ...
          <section className="express-checkout-section">
            <span className="express-checkout-title">
